...
glm::vec3 mainPosition = glm::vec3(0.0f, 0.0f, 8.0f);

// Camera
Camera cameraStatic(glm::vec3(0.0f, 0.0f, 8.0f));
Camera cameraStaticFollowing(glm::vec3(10.0f, 0.0f, -3.0f), mainPosition - glm::vec3(10.0f, 0.0f, -3.0f));
...
int main()
{
	...
	// Setting up vertices and shaders
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelFirst = glm::rotate(modelFirst, (float)glfwGetTime() * glm::radians(50.0f), glm::vec3(0.5f, 1.0f, 0.0f));
		myShader.setMat4("model", modelFirst);
